...
namespace Px.Utils.PxFile.Metadata
{
    ...
    public interface IPxFileMetadataReader
    {
        ...
        IEnumerable<KeyValuePair<string, string>> ReadMetadata(Stream stream, Encoding encoding,  int readBufferSize = 4096);
        ...
        Dictionary<string, string> ReadMetadataToDictionary(Stream stream, Encoding encoding, int readBufferSize = 4096);
