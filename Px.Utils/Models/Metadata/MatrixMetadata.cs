...
{
    public class MatrixMetadata(string defaultLanguage, List<string> availableLanguages, List<IDimension> dimensions, List<Property> additionalProperties) : IReadOnlyMatrixMetadata
    {
