...
namespace PxUtils.Models.Metadata.Dimensions
{
    public class ContentDimensionValue : DimensionValue
    {
        ...
        public ContentDimensionValue(string code, MultilanguageString name, MultilanguageString unit, DateTime lastUpdated, int precision, bool isVirtual) : base(code, name, isVirtual)
        {
            Unit = unit;
            LastUpdated = lastUpdated;
            Precision = precision;
        ...
        /// <param name="lastUpdated">The date and time when the data described by this dimension value was last updated</param>
        /// <param name="precision">The number of decimal places to which the data described by this dimension value is rounded</param>
        public ContentDimensionValue(DimensionValue dimensionValue, MultilanguageString unit, DateTime lastUpdated, int precision) : base(dimensionValue.Code, dimensionValue.Name, dimensionValue.Virtual)
        {
            Unit = unit;
            LastUpdated = lastUpdated;
            Precision = precision;
