namespace PxUtils.Validation.ContentValidation
{
    ...
    public class CustomContentValidationFunctions(
        List<ContentValidationSearchDelegate> contentValidationSearchFunctions,
        List<ContentValidationEntryDelegate> contentValidationEntryFunctions
        )
    {
        public List<ContentValidationSearchDelegate> CustomContentValidationSearchFunctions { get; } = contentValidationSearchFunctions;
