...
{
    internal static class PxFileMetaEntries_Robust_3_Languages
    {
        public static List<KeyValuePair<string, string>> Entries =
            [
                ...
                new("LAST-UPDATED(\"Muutos edelliseen vuoteen (indeksi 2015=100)\")", "20230131 08:00"),
                new("LAST-UPDATED[sv](\"Årsförändring (index 2015=100)\")", "20230131 08:00"),
                new("LAST-UPDATED[en](\"Annual change (index 2015=100)\")", "20230131 08:00"),
                new("LAST-UPDATED(\"Kauppojen lukumäärä\")", "20230131 08:00"),
                new("LAST-UPDATED[sv](\"Antal\")", "20230131 08:00"),
                new("LAST-UPDATED[en](\"Number\")", "20230131 08:00"),
