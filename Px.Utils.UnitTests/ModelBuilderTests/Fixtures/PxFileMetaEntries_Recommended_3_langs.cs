...
{
    internal static class PxFileMetaEntries_Recommended_3_Langs
    {
        public static List<KeyValuePair<string, string>> Entries =
            [
                ...
                new("VARIABLECODE(\"Vuosi\")", "\"year\""),
                new("VARIABLECODE[sv](\"År\")", "\"year\""),
                new("VARIABLECODE[en](\"Year\")", "\"year\""),
                new("VARIABLECODE(\"Alue\")", "\"area\""),
                new("VARIABLECODE[sv](\"Område\")", "\"area\""),
                new("VARIABLECODE[en](\"Region\")", "\"area\""),
                new("VARIABLECODE(\"Talotyyppi\")", "\"type\""),
                new("VARIABLECODE[sv](\"Hustyp\")", "\"type\""),
                new("VARIABLECODE[en](\"Building type\")", "\"type\""),
                new("VARIABLECODE(\"Tiedot\")", "\"info\""),
                new("VARIABLECODE[sv](\"Uppgifter\")", "\"info\""),
                new("VARIABLECODE[en](\"Information\")", "\"info\""),
                ...
                new("LAST-UPDATED(\"Tiedot\",\"Indeksi (2015=100)\")", "\"20230131 08:00\""),
                new("LAST-UPDATED[sv](\"Uppgifter\",\"Index (2015=100)\")", "\"20230131 08:00\""),
                new("LAST-UPDATED[en](\"Information\",\"Index (2015=100)\")","\"20230131 08:00\""),
                new("LAST-UPDATED(\"Tiedot\",\"Muutos edelliseen vuoteen (indeksi 2015=100)\")", "\"20230131 09:00\""),
                new("LAST-UPDATED[sv](\"Uppgifter\",\"Årsförändring (index 2015=100)\")", "\"20230131 09:00\""),
                new("LAST-UPDATED[en](\"Information\",\"Annual change (index 2015=100)\")", "\"20230131 09:00\""),
                new("LAST-UPDATED(\"Tiedot\",\"Kauppojen lukumäärä\")", "\"20230131 10:00\""),
                new("LAST-UPDATED[sv](\"Uppgifter\",\"Antal\")", "\"20230131 10:00\""),
                new("LAST-UPDATED[en](\"Information\",\"Number\")", "\"20230131 10:00\""),
                new("UNITS(\"Tiedot\",\"Indeksi (2015=100)\")", "\"indeksipisteluku\""),
                new("UNITS[sv](\"Uppgifter\",\"Index (2015=100)\")", "\"indextal\""),
                new("UNITS[en](\"Information\",\"Index (2015=100)\")", "\"index point\""),
                new("UNITS(\"Tiedot\",\"Muutos edelliseen vuoteen (indeksi 2015=100)\")", "\"%\""),
                new("UNITS[sv](\"Uppgifter\",\"Årsförändring (index 2015=100)\")", "\"%\""),
                new("UNITS[en](\"Information\",\"Annual change (index 2015=100)\")", "\"%\""),
                new("UNITS(\"Tiedot\",\"Kauppojen lukumäärä\")", "\"lukumäärä\""),
                new("UNITS[sv](\"Uppgifter\",\"Antal\")", "\"antal\""),
                new("UNITS[en](\"Information\",\"Number\")", "\"number\""),
