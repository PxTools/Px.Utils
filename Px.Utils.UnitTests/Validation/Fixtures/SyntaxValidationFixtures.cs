...
namespace Px.Utils.UnitTests.Validation.Fixtures
{
    internal static class SyntaxValidationFixtures
    {
        ...
        internal static List<ValidationStructuredEntry> STRUCTURED_ENTRIES_WITH_INVALID_KEYWORDS => [
            new("foo", numberInKeyword, "foo", 0, [], 0, Utils.Validation.ValueType.StringValue),
            new("foo", slashInKeyword, "bar", 0, [], 0, Utils.Validation.ValueType.StringValue),
            new("foo", colonInKeyword, "baz", 0, [], 0, Utils.Validation.ValueType.StringValue)
        ];
        ...
        internal static List<ValidationStructuredEntry> STRUCTURED_ENTRIES_WITH_VALID_LANGUAGES => [
            new("foo", fi, "foo", 0, [], 0, Utils.Validation.ValueType.StringValue),
            new("foo", fin, "bar", 0, [], 0, Utils.Validation.ValueType.StringValue),
            new("foo", fiFi, "baz", 0, [], 0, Utils.Validation.ValueType.StringValue)
        ];
        ...
        internal static List<ValidationStructuredEntry> STRUCTURED_ENTRIES_WITH_INVALID_LANGUAGES => [
            new("foo", fien, "foo", 0, [], 0, Utils.Validation.ValueType.StringValue)
        ];
        ...
        internal static List<ValidationStructuredEntry> STRUCTURED_ENTRIES_WITH_INCOMPLIANT_LANGUAGES => [
            new("foo", finnish, "foo", 0, [], 0, Utils.Validation.ValueType.StringValue),
            new("foo", engl, "foo", 0, [], 0, Utils.Validation.ValueType.StringValue)
        ];
        ...
        internal static List<ValidationStructuredEntry> STRUCTS_WITH_LONG_KEYWORD => [
            new("foo", longKeyword, "foo", 0, [], 0, Utils.Validation.ValueType.StringValue)
        ];
        ...
        internal static List<ValidationStructuredEntry> STRUCTURED_ENTRIES_WITH_UNRECOMMENDED_KEYWORD_NAMING => [
            new("foo", pascalCaseKeyword, "foo", 0, [], 0, Utils.Validation.ValueType.StringValue),
            new("foo", screamingSnakeCaseKeyword, "foo", 0, [], 0, Utils.Validation.ValueType.StringValue)
        ];
    }
}
