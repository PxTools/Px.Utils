    ...
    public class Int32CodecTests
    {
        ...
        public void WriteReadExistsRoundtrip()
        {
            ...
            DoubleDataValue[] input = [
                new DoubleDataValue(int.MinValue, DataValueType.Exists),
                new DoubleDataValue(0, DataValueType.Exists),
                new DoubleDataValue(int.MaxValue - 8, DataValueType.Exists) // Adjusted to avoid sentinel values
             ];
